...
```python
from infra.logging import set_request_context, clear_request_context
...
**開発環境:**
```
2025-01-10 10:30:45 [info     ] Payment completed   order_id=order-123 amount=1000
```

**本番環境 (JSON):**
```json
{"timestamp":"2025-01-10T01:30:45.123Z","level":"info","event":"Payment completed","order_id":"order-123","amount":1000}
```
